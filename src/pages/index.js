	...
	<Layout>
		...
		<div className="hero-container bg-cover">
			<div className="container flex-wrap mx-auto lg:my-0 px-8 py-4 lg:pt-32 sm:pt-20 relative">
				...
				<p className="mt-4 text-xl md:text-2xl text-gray-100 w-full md:w-1/2 pb-40 sm:pb-40 md:pb-20 lg:pb-10">I am a ux leader who loves to inspire and be inspired by design. Great design disrupts markets and delights users.</p>
				...
				<div className="absolute inset-x-0 bottom-0 md:static w-2/3 md:w-2/5 flex flex-wrap items-center justify-between lg:mb-48 mb-5 ml-6 md:ml-0">
					<a className="border border-gray-600 bg-white rounded-full p-2 lg:p-4 border-2 hover:shadow-xl" target="_blank" rel="noopener noreferrer" aria-label="Linkedin" href="https://www.linkedin.com/in/jimnieters/en">
					...
					<a className="border border-gray-600 bg-white rounded-full p-2 lg:p-4 border-2 hover:shadow-xl" href="mailto:jnieters@mac.com" data-tippy-content="@twitter_handle"  aria-label="Mail">
					...
					<a className="border border-gray-600 bg-white rounded-full p-2 lg:p-4 border-2 hover:shadow-xl"  target="_blank" rel="noopener noreferrer"  aria-label="Twitter" href="https://twitter.com/jimnieters" >
					...
					<a className="border border-gray-600 bg-white rounded-full p-2 lg:p-4 border-2 hover:shadow-xl" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/JimNieters"  aria-label="Facebook" >
					...
					<a className="border border-gray-600 bg-white rounded-full p-2 lg:p-4 border-2 hover:shadow-xl" target="_blank" rel="noopener noreferrer" href="https://about.me/jnieters" data-tippy-content="@facebook_handle"  aria-label="Aboutme">
