			...
			<Layout className="dark:bg-gray-900">
				...
				<div className="hero-container bg-cover">
					<div className="container flex-wrap mx-auto lg:my-0 px-8 py-4 lg:pt-32 sm:pt-20 relative">
						...
						<p className="mt-1 text-2xl lg:text-4xl font-bold font-title text-gray-100 dark:text-black flex tracking-tight lg:justify-start">User Experience Design Leader</p>
						<p className="mt-1 text-gray-100 dark:text-gray-700 text-2xl flex lg:justify-start font-medium lg:pb-10">San Francisco, Bay Area</p>
