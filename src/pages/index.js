		...
		<div className="hero-container bg-cover">
			<div className="max-w-6xl flex items-center flex-wrap mx-auto lg:my-0 py-12 ">
				<div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-3xl bg-white opacity-100 mx-6 lg:mx-0 py">
					...
					<div className="p-4 md:p-12 text-center lg:text-left">
						...
						<div className="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
							...
							<a className="border border-gray-200 rounded-full p-3 shadow-md hover:shadow-xl" target="_blank" href="https://www.linkedin.com/in/jimnieters/en">
							...
							<a className="border border-gray-200 rounded-full p-3 shadow-md hover:shadow-xl"  target="_blank" href="https://twitter.com/jimnieters" >
							...
							<a className="border border-gray-200 rounded-full p-3 shadow-md hover:shadow-xl" href="https://www.facebook.com/JimNieters" >
							...
							<a className="border border-gray-200 rounded-full p-3 shadow-md hover:shadow-xl" href="https://about.me/jnieters" data-tippy-content="@facebook_handle">
				...
				<div className="w-full lg:w-2/5 relative">
					<img src="/images/jim-folio-3.jpg" className="rounded-none w-full lg:rounded-lg shadow-2xl hidden lg:block" />
